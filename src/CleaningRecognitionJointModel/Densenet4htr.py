...
class Densenet4htr:
  ...
  def _build_graph(self):
    ...
    with tf.variable_scope("graph_recognition"):
        self.is_training = tf.placeholder(tf.bool, shape=[])
...
# def densenet_feature_extractor(inputTensor, growth_rate=12, depth=40, total_blocks=3, keep_prob=1, reduction=0.5, bc_mode=True):
